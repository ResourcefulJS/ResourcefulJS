...
//    };
    ...
    DefinedResource.prototype = Object.create(Resource.prototype, { 'constructor': DefinedResource });

//    DefinedResource.name = name;
    DefinedResource._datastoreAdapter = null;

    DefinedResource.get = function(id) {
        return this._datastoreAdapter.findResourceById(id);
    };
